...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-pause-verify" = rec {
        crateName = "k8s-pause-verify";
        version = "0.1.1";
        edition = "2024";
        crateBin = [
          {
            name = "k8s-pause-verify";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "pleme-actions-shared";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "pleme-actions-shared" = rec {
        crateName = "pleme-actions-shared";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/pleme-actions-shared";
          rev = "74c72ebff2dedf53f649c7b4cbd53998227eb956";
          sha256 = "1lkchajc3bwv245wdfiklgz7b7kl6i9pi89wc8h7vrpbl9clq3lh";
        };
